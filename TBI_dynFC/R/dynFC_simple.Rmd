...
knitr::opts_knit$set(root.dir = '/home/ben/Benslab/project_TBI/SeeElephants/TBI_dynFC')
library(tidyverse)
library(RcppRoll)
library(reshape2)
library(DAAG)
...
```{r correlate}
# s1c1.rifg.lhpc <- corr_rollme(df, 1, 1, c("roi1_rifg", "roi2_lhpc"), 10, 5)
# c1All.rifg.lhpc <- corr_rollme_all(df, 1, c("roi1_rifg", "roi2_lhpc"), 10, 5)
# c2all.rifg.lhpc <- corr_rollme_all(df, 2, c("roi1_rifg", "roi2_lhpc"), 10, 5)

# PRE - TESTS
#####################################

# ROI 1 R IFG x ROI2 L HPC - COND1
all2allc1.rifg.lhpc <- corr_rollme_all2all(df, CND, c("roi1_rifg", "roi2_lhpc"), wndw, step, method)
...
all2allc1.rifg.rnac <- corr_rollme_all2all(df, CND, c("roi1_rifg", "roi2_rnac"), wndw, step, method)
...
all2allc1.racc.lstg <- corr_rollme_all2all(df, CND, c("roi1_racc", "roi2_lstg"), wndw, step, method)
...
all2allc1.racc.rtpo <- corr_rollme_all2all(df, CND, c("roi1_racc", "roi2_rtpo"), wndw, step, method)
...
all2allc2.rifg.lhpc <- corr_rollme_all2all(df, CND, c("roi1_rifg", "roi2_lhpc"), wndw, step, method)
...
all2allc2.rifg.rnac <- corr_rollme_all2all(df, CND, c("roi1_rifg", "roi2_rnac"), wndw, step, method)
...
all2allc2.racc.lstg <- corr_rollme_all2all(df, CND, c("roi1_racc", "roi2_lstg"), wndw, step, method)
...
all2allc2.racc.rtpo <- corr_rollme_all2all(df, CND, c("roi1_racc", "roi2_rtpo"), wndw, step, method)
...
# Naive ways
t.test(allc2.racc.lstg - allc1.racc.lstg)
onet.permutation(allc2.racc.lstg - allc1.racc.lstg)
# COCOR way (needs correlations of all combos)
racc1.racc2 <- corr_rollme_all(df, c(1, 2), c("roi1_racc", "roi1_racc"), wndw, step)
racc1.lstg2 <- corr_rollme_all(df, c(1, 2), c("roi1_racc", "roi2_lstg"), wndw, step)
lstg1.racc2 <- corr_rollme_all(df, c(1, 2), c("roi2_lstg", "roi1_racc"), wndw, step)
...
t.test(allc2.racc.rtpo - allc1.racc.rtpo)
onet.permutation(allc2.racc.rtpo - allc1.racc.rtpo)

t.test(allc2.rifg.lhpc - allc1.rifg.lhpc)
onet.permutation(allc2.rifg.lhpc - allc1.rifg.lhpc)

t.test(allc2.rifg.rnac - allc1.rifg.rnac)
onet.permutation(allc2.rifg.rnac - allc1.rifg.rnac)
