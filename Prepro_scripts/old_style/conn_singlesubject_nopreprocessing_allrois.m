...
STRUCTURAL_FILE=cellstr(spm_select('FPList',fullfile(sub_path, 'T1'), '^wrofLASA.*\.nii$'));
nses=1;
ncond=1;
TR=1.5; %(seconds)
%% PREPARES connectivity analyses
clear batch;
batch.filename=fullfile(data_path,'conn_ID102_seed_nopreprocessing.mat');
%% CONN Setup
batch.Setup.RT=TR;
...
batch.Setup.masks.Grey.files{nsub}=cellstr(fullfile(sub_path,'T1','wc1rofLASA_ID102_1_20171215175412___GR_IR___tfl3d1_16ns_9.nii'));
batch.Setup.masks.Grey.dimensions=1;
batch.Setup.masks.White.files{nsub}=cellstr (fullfile(sub_path,'T1','wc2rofLASA_ID102_1_20171215175412___GR_IR___tfl3d1_16ns_9.nii'));
batch.Setup.masks.White.dimensions=3;
batch.Setup.masks.CSF.files{nsub}=cellstr (fullfile(sub_path,'T1','wc3rofLASA_ID102_1_20171215175412___GR_IR___tfl3d1_16ns_9.nii'));
...
batch.Analysis.type=2; %1=ROI-to-ROI analysis, 2= seed-to-voxel analysis, 3= both;
